...
function draw_tiny_index(index){

    var temp_element = document.createElement("div");
        var temp_id  = "small_vis"+index;
        temp_element.setAttribute("id", temp_id);
        document.getElementById("small_vis_chart").innerHTML = "";
        document.getElementById("small_vis_chart").appendChild(temp_element);
